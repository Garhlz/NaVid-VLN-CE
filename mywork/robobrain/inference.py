...
#     model = SimpleInference('/data/model_zoo/RoboBrain2.0-7B')
...
#     # 描述你想在图中找到的物体
#     prompt = "the father on the right"
#     image = '/home/huahaoming/RoboBrain2.0/RoboBrain2.0-main/assets/demo/grounding.jpg'

#     pred = model.inference(
#         text=prompt, 
#         image=image, 
#         task="grounding",  # <<< 任务类型改为 "grounding"
#         enable_thinking=False,
#         plot=True          # <<< 设为 True 来生成带标注的图片
#     )
#     print(f"Prediction:\n{pred}")
...
#     # 描述你想让模型指出的具体位置
#     prompt = "point to the handle of the two cups"
#     image = "/home/huahaoming/RoboBrain2.0/RoboBrain2.0-main/assets/demo/pointing.jpg"

#     pred = model.inference(
#         text=prompt, 
#         image=image, 
#         task="pointing",  # <<< 任务类型改为 "pointing"
#         enable_thinking=False,
#         plot=True
#     )
#     print(f"Prediction:\n{pred}")
...
if __name__ == "__main__":
    ...
    image = "/home/huahaoming/RoboBrain2.0/RoboBrain2.0-main/assets/demo/trajectory.jpg"

    pred = model.inference(
        text=prompt, 
        image=image, 
        task="trajectory",  # <<< 任务类型改为 "trajectory"
        enable_thinking=False,
        plot=True
    )
    print(f"Prediction:\n{pred}")